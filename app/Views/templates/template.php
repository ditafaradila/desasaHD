...
<head>
    ...
    <link rel="icon" type="image/png" href="../assets/img/logo desasa.png">
    <title>
        Desasa Homedecor
    </title>
    <!--     Fonts and icons     -->
    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
        <div class="sidenav-header">
            ...
            <a class="navbar-brand m-0" href="/dashboard">
                <img src="../assets/img/logo desasa.png" class="navbar-brand-img h-100" alt="main_logo">
                <span class="ms-1 font-weight-bold">Desasa Homedecor</span>
            </a>
        </div>
        ...
        <div class="collapse navbar-collapse  w-auto  max-height-vh-100 h-100" id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link <?= ($title == "Supply") ? 'active' : '' ?> " href="/supply">
                        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <li class="nav-item">
                    <a class="nav-link /" data-bs-target="#components-nav" data-bs-toggle="collapse" href="#">
                        ...
                        <span class="nav-link-text ms-1">Master Data</span><i class="bi bi-chevron-down ms-auto"></i>
                    </a>
                    <ul id="components-nav" class="navbar-nav collapse collapsed" data-bs-parent="#sidebar-nav">
                        <li class="nav-item">
                            <a class="nav-link  <?= ($title == "Bahan Baku") ? 'active' : '' ?> " href="/bahanbaku">
                                <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        ...
                        <li class="nav-item">
                            <a class="nav-link  <?= ($title == "Tambah Produk") ? 'active' : '' ?> " href="/tambahProduk">
                                <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                                    <path d="M256 80c0-17.7-14.3-32-32-32s-32 14.3-32 32V224H48c-17.7 0-32 14.3-32 32s14.3 32 32 32H192V432c0 17.7 14.3 32 32 32s32-14.3 32-32V288H400c17.7 0 32-14.3 32-32s-14.3-32-32-32H256V80z"/>
                                </svg>
                                </div>
                                <span class="nav-link-text ms-1">Tambah Produk Toko</span>
                            </a>
                        </li>
                    </ul>
                </li>
                <li class="nav-item">
                    <a class="nav-link  <?= ($title == "Produk Toko") ? 'active' : '' ?> " href="/produk">
                        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                <title>box-3d-50</title>
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        ...
                        <span class="nav-link-text ms-1">Produk Toko</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link  <?= ($title == "Produk Shopee") ? 'active' : '' ?> " href="/produkShopee">
                        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                <title>box-3d-50</title>
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
