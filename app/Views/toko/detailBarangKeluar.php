                            ...
                            <table class="table align-items-center mb-0">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        ...
                                        <div class="modal fade" id="editBK-<?= $barangKeluar['id_barangKeluar'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <form action="<?= base_url('/updateBK/' . $barangKeluar['id_barangKeluar']) ?>" method="post">
                                                        <?= csrf_field(); ?>
                                                        <div class="modal-body">
                                                            <div class="form-group">
                                                                <label for="jumlah_barangKeluar">Jumlah</label>
                                                                <input type="text" class="form-control" name="jumlah_barangKeluar" id="jumlah_barangKeluar" value="<?= $barangKeluar['jumlah_barangKeluar'] ?>">
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="tanggal_barangKeluar">Tanggal</label>
                                                                <input type="date" class="form-control" name="tanggal_barangKeluar" id="tanggal_barangKeluar" value="<?= $barangKeluar['tanggal_barangKeluar'] ?>">
                                                            </div>
                                                            <div align="center">
