                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td class="align-middle text-center">
                                            <span class="text-secondary text-xs font-weight-bold">Rp <?= number_format($supply['harga_supply']) ?></span>
                                        </td>
                                        <td class="align-middle text-center">
                                        ...
                                        <td>
                                            <div class="d-flex" align="center">
                                                ...
                                                <a href="/editSupply/<?= $supply['id_supply'] ?>" type="button" class="btn btn-link text-dark px-1 mb-0"><i class="fa fa-pencil"></i></a>
                                            </div>
                                        </td>
                                    </tr>
                                <?php
