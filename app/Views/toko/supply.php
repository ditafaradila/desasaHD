                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <p class="text-xs font-weight-bold mb-0"><?= $totalSupply['jenis_barang'] ?></p>
                                            </td>
                                            <td class="align-middle text-center text-sm">
                                                <p class="text-xs font-weight-bold mb-0"><?= $totalSupply['total_jumlah_supply'] ?></p>
                                            </td>
                                            <td class="align-middle text-center text-sm">
                                                <p class="text-xs font-weight-bold mb-0"><?= $totalSupply['total_harga_supply'] ?></p>
                                            </td>
                                            <td class="align-middle text-center text-sm">
                                                <p class="text-xs font-weight-bold mb-0"><?= $totalSupply['max_tanggal_supply'] ?></p>
                                            </td>
                                            <td>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <p class="text-xs font-weight-bold mb-0"><?= $totalBarangKeluar['jenis_barang'] ?></p>
                                            </td>
                                            <td class="align-middle text-center text-sm">
                                                <p class="text-xs font-weight-bold mb-0"><?= $totalBarangKeluar['total_jumlah_barangKeluar'] ?></p>
                                            </td>
                                            <td class="align-middle text-center">
                                                <span class="text-secondary text-xs font-weight-bold"><?= $totalBarangKeluar['max_tanggal_barangKeluar'] ?></span>
                                            </td>
                                            <td>
                                                <div class="align-middle text-center text-sm">
