                    ...
                    <div class="card-body p-3 d-flex align-items-center">
                        <div class="flex-grow-1">
                            <div class="numbers">
                                ...
                                <h5 class="text-white font-weight-bolder mb-0 text-end"><?php echo $totalToko ?> Produk</h5>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card bg-gradient-dark">
                    <div class="card-body p-3">
                        <div class="row">
                            <div class="col-8">
                                <div class="numbers">
                                    <p class="text-white text-sm mb-0 text-capitalize font-weight-bold">Ada Pembeli di Toko?</p>
                                </div>
                            </div>
                            <div class="col-4 text-end">
                                <a href="/tambahTransaksi" type="button" class="icon icon-shape bg-gradient-primary shadow text-center border-radius-md" data-bs-toggle="modal" data-bs-target="#tambahTransaksi">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <p class="shorten-text text-xs font-weight-bold mb-0"><?= $transaksi['nama_produk'] ?></p>
                                            </td>
                                            <td class="align-middle text-center text-sm">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="row">
                                                            <div class="timeline-content mb-3 col-6">
                                                                ...
                                                                <p class="shorten-text text-secondary font-weight-bold text-xs mt-1 mb-0"><?= $transaksi['nama_produk'] ?></p>
                                                            </div>
                                                            <div class="timeline-content mb-3 col-6">
                                                                <h5 class="text-dark text-sm font-weight-bold mb-0">Metode Pembayaran</h5>
                                                                <p class="text-secondary font-weight-bold text-xs mt-1 mb-0"><?= $transaksi['metode_bayar'] ?></p>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="timeline-content mb-3 col-6">
                                                                <h5 class="text-dark text-sm font-weight-bold mb-0">Diskon</h5>
                                                                <p class="text-secondary font-weight-bold text-xs mt-1 mb-0">Rp <?= number_format($transaksi['diskon']) ?></p>
                                                            </div>
                                                            <div class="timeline-content mb-3 col-6">
                                                                <h5 class="text-dark text-sm font-weight-bold mb-0">Tanggal Transaksi</h5>
                                                                <p class="text-secondary font-weight-bold text-xs mt-1 mb-0"><?= $transaksi['waktu'] ?></p>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="timeline-content mb-3 col-6">
                                                                <h5 class="text-dark text-sm font-weight-bold mb-0">Harga Awal</h5>
                                                                <p class="text-secondary font-weight-bold text-xs mt-1 mb-0">Rp <?= number_format($transaksi['harga_produk']) ?></p>
                                                            </div>
                                                            <div class="timeline-content mb-3 col-6">
                                                                <h5 class="text-dark text-sm font-weight-bold mb-0">Harga Akhir</h5>
                                                                <p class="text-secondary font-weight-bold text-xs mt-1 mb-0">Rp <?= number_format($transaksi['nominal']) ?></p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="modal fade" id="editTransaksi-<?= $transaksi['id_transaksi'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h6 class="modal-title" id="exampleModalLabel">Edit Transaksi Toko</h6>
                                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"><span aria-hidden="true" style="color: black;">&times;</span></button>
                                                    </div>
                                                                ...
                                                                <select name="id_produk" id="id_produk">
                                                                    ...
                                                                    <?php foreach ($produkList as $produkItem) : ?>
                                                                        <option value="<?= $produkItem->id_produk ?>" data-harga="<?= $produkItem->harga_produk ?>">
                                                                            <span class="shorten-text"><?= $produkItem->nama_produk ?></span> / <?= $produkItem->harga_produk ?>
                                                                        </option>
                                                                    <?php endforeach; ?>
                                                                </select>
                                                            </div>
